...
#[allow(dead_code)]
pub fn e7(n: usize) -> usize {
    Primes::new().get(n - 1)
}

#[allow(dead_code)]
#[allow(unstable)]
pub fn e8(n: usize) -> usize {
